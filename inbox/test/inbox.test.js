...
const web3 = new Web3(ganache.provider()); // local test network 에의 연결을 허용
// const { interface, bytecode } = require("../compile"); // interface : translation layer (network 데이터를 자바스크립트 월드로 가져옴)
